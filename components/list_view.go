...
func (lv *ListView) SyncFrom(src core.Element) {
	...
	sb := &core.SyncBuilder{}
	core.SyncField(sb, &lv.selectedIdx, other.selectedIdx)
	core.SyncColor(sb, &lv.bgNormal, other.bgNormal)
	core.SyncColor(sb, &lv.bgSelected, other.bgSelected)
	core.SyncColor(sb, &lv.bgHover, other.bgHover)
	sb.MarkDraw(lv)
}
