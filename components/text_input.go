...
func (ti *TextInput) Draw(screen *ebiten.Image) {
	...
	native.DrawRoundedRectFill(screen, bounds.X, bounds.Y, bounds.Width, bounds.Height, brAll, ti.bgColor)
	...
	if borderClr != nil {
		native.DrawRoundedRectStroke(screen, bounds.X, bounds.Y, bounds.Width, bounds.Height, brAll, 1, borderClr)
	}
...
func (ti *TextInput) SyncFrom(src core.Element) {
	...
	sb := &core.SyncBuilder{}
	core.SyncField(sb, &ti.placeholder, other.placeholder)
	core.SyncField(sb, &ti.isMultiline, other.isMultiline)
	...
	if !core.ColorsEqual(ti.textColor, other.textColor) || !core.ColorsEqual(ti.placeholderColor, other.placeholderColor) ||
		!core.ColorsEqual(ti.cursorColor, other.cursorColor) || !core.ColorsEqual(ti.borderColor, other.borderColor) ||
		!core.ColorsEqual(ti.focusBorderColor, other.focusBorderColor) || !core.ColorsEqual(ti.bgColor, other.bgColor) ||
		!core.ColorsEqual(ti.selectionColor, other.selectionColor) || !core.ColorsEqual(ti.compositionColor, other.compositionColor) {
