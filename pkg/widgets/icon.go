...
func (i IconWidget) CreateElement() engine.Element {
	return engine.NewRenderObjectElement(i)
}

func (i IconWidget) GetKey() engine.Key { return engine.NilKey{} }

// CreateRenderObject implements RenderObjectFactory.
func (i IconWidget) CreateRenderObject(element engine.Element) render.RenderObject {
...
func (i IconWidget) UpdateRenderObject(ro render.RenderObject, oldWidget engine.Widget) {
