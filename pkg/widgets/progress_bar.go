...
func (p GameProgressBarWidget) CreateElement() engine.Element {
	return engine.NewRenderObjectElement(p)
}

func (p GameProgressBarWidget) CreateRenderObject(element engine.Element) render.RenderObject {
...
func (p GameProgressBarWidget) UpdateRenderObject(ro render.RenderObject, oldWidget engine.Widget) {
