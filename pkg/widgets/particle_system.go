...
func (p ParticleSystemWidget) CreateElement() engine.Element {
	return engine.NewRenderObjectElement(p)
}

// CreateRenderObject implements RenderObjectFactory.
func (p ParticleSystemWidget) CreateRenderObject(element engine.Element) render.RenderObject {
...
func (p ParticleSystemWidget) UpdateRenderObject(ro render.RenderObject, oldWidget engine.Widget) {
