...
func (b ButtonWidget) CreateRenderObject(element engine.Element) render.RenderObject {
	t := engine.GetTheme()
...
func applyButtonVariant(r *render.RenderButton, variant ButtonVariant, t *engine.Theme) {
	switch variant {
	case ButtonDefault:
...
func (b ButtonWidget) UpdateRenderObject(ro render.RenderObject, oldWidget engine.Widget) {
...
func (b ButtonWidget) GetChildWidget() engine.Widget {
	textColor := buttonTextColor(b.variant, engine.GetTheme())
	return Text(b.label).FontSize(engine.GetTheme().FontSizeBase).Color(textColor)
}

// buttonTextColor returns the text color for a given button variant.
func buttonTextColor(variant ButtonVariant, t *engine.Theme) color.Color {
	switch variant {
	case ButtonLink:
