...
func EditableText(content string) EditableTextWidget {
	return EditableTextWidget{
		...
		placeholderColor: engine.GetTheme().InputPlaceholderColor,
	}
}
...
func (e EditableTextWidget) CreateElement() engine.Element {
	return engine.NewRenderObjectElement(e)
}

// CreateRenderObject implements RenderObjectFactory.
func (e EditableTextWidget) CreateRenderObject(element engine.Element) render.RenderObject {
...
func (e EditableTextWidget) UpdateRenderObject(ro render.RenderObject, oldWidget engine.Widget) {
...
func TextField(initial string) TextFieldWidget {
	return TextFieldWidget{
		...
		borderWidth:      1,
		borderRadius:     4,
		padding:          engine.EdgeInsets{Left: 8, Right: 8, Top: 8, Bottom: 8},
	}
}
...
func (t TextFieldWidget) Pad(insets engine.EdgeInsets) TextFieldWidget {
	t.padding = insets
	return t
}
...
func (t TextFieldWidget) CreateElement() engine.Element {
	return engine.NewSingleChildRenderObjectElement(t)
}

// CreateRenderObject implements RenderObjectFactory.
func (t TextFieldWidget) CreateRenderObject(element engine.Element) render.RenderObject {
...
// UpdateRenderObject implements RenderObjectUpdater.
func (t TextFieldWidget) UpdateRenderObject(ro render.RenderObject, oldWidget engine.Widget) {
	old := oldWidget.(TextFieldWidget)
	applyTextFieldProps(ro.(*render.RenderBox), old, t)
}

// GetChildWidget implements SingleChildProvider.
func (t TextFieldWidget) GetChildWidget() engine.Widget {
