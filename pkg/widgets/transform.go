...
func Transform(child engine.Widget) TransformWidget {
...
func (t TransformWidget) CreateElement() engine.Element {
...
func (e *TransformElement) Update(newWidget engine.Widget) {
	e.widget = newWidget.(TransformWidget)
	e.SingleChildComponentElement.Update(newWidget)
}

func (e *TransformElement) UpdateChild(oldWidget engine.Widget) {
...
func (e *TransformElement) Mount(parent engine.Element, slot int) {
