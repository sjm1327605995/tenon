...
func (c Card3DWidget) CreateElement() engine.Element {
	return engine.NewSingleChildRenderObjectElement(c)
}

func (c Card3DWidget) CreateRenderObject(element engine.Element) render.RenderObject {
	img := c.visibleFace()
...
func (c Card3DWidget) UpdateRenderObject(ro render.RenderObject, oldWidget engine.Widget) {
...
func (c Card3DWidget) GetChildWidget() engine.Widget {
	return nil
}
