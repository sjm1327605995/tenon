...
func Container(child engine.Widget) ContainerWidget {
...
func (c ContainerWidget) Pad(insets engine.EdgeInsets) ContainerWidget { return c.Padding(insets) }
func (c ContainerWidget) Padding(insets engine.EdgeInsets) ContainerWidget {
	c.padding = insets
	return c
}

func (c ContainerWidget) Marginf(insets engine.EdgeInsets) ContainerWidget { return c.Margin(insets) }
func (c ContainerWidget) Margin(insets engine.EdgeInsets) ContainerWidget {
	c.margin = insets
	return c
}
...
func (c ContainerWidget) CreateElement() engine.Element {
	return engine.NewSingleChildRenderObjectElement(c)
}

// CreateRenderObject implements RenderObjectFactory.
func (c ContainerWidget) CreateRenderObject(element engine.Element) render.RenderObject {
...
func (c ContainerWidget) UpdateRenderObject(ro render.RenderObject, oldWidget engine.Widget) {
	old := oldWidget.(ContainerWidget)
	applyContainerProps(ro.(*render.RenderBox), old, c)
}

// GetChildWidget implements SingleChildProvider.
func (c ContainerWidget) GetChildWidget() engine.Widget {
	return c.child
}
...
func applyContainerProps(r *render.RenderBox, old, w ContainerWidget) {
	...
	if old.padding != w.padding {
		r.StyleSetPadding(engine.EdgeTop, w.padding.Top)
		r.StyleSetPadding(engine.EdgeRight, w.padding.Right)
		r.StyleSetPadding(engine.EdgeBottom, w.padding.Bottom)
		r.StyleSetPadding(engine.EdgeLeft, w.padding.Left)
	}
	if old.margin != w.margin {
		r.StyleSetMargin(engine.EdgeTop, w.margin.Top)
		r.StyleSetMargin(engine.EdgeRight, w.margin.Right)
		r.StyleSetMargin(engine.EdgeBottom, w.margin.Bottom)
		r.StyleSetMargin(engine.EdgeLeft, w.margin.Left)
	}
