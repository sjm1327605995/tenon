...
func (s SpriteWidget) CreateElement() ui.Element {
	return ui.NewRenderObjectElement(s)
}

func (s SpriteWidget) CreateRenderObject(e ui.Element) render.RenderObject {
...
func (s SpriteWidget) UpdateRenderObject(ro render.RenderObject, old ui.Widget) {
