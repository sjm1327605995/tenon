...
func (b SpriteButtonWidget) CreateElement() ui.Element {
	return ui.NewSingleChildRenderObjectElement(b)
}

func (b SpriteButtonWidget) CreateRenderObject(element ui.Element) render.RenderObject {
...
func (b SpriteButtonWidget) UpdateRenderObject(ro render.RenderObject, oldWidget ui.Widget) {
...
func (b SpriteButtonWidget) GetChildWidget() ui.Widget {
	if b.label == "" {
		return nil
	}
	return Text(b.label).FontSize(ui.GetTheme().FontSizeBase)
}
