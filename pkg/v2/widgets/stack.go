...
func (s StackWidget) CreateElement() ui.Element {
	return ui.NewMultiChildRenderObjectElement(s)
}

// CreateRenderObject implements RenderObjectFactory.
func (s StackWidget) CreateRenderObject(element ui.Element) render.RenderObject {
...
func (s StackWidget) UpdateRenderObject(ro render.RenderObject, oldWidget ui.Widget) {
...
func (s StackWidget) GetChildrenWidgets() []ui.Widget {
	return s.children
}
...
func (p PositionedWidget) CreateElement() ui.Element {
	return ui.NewSingleChildRenderObjectElement(p)
}

// CreateRenderObject implements RenderObjectFactory.
func (p PositionedWidget) CreateRenderObject(element ui.Element) render.RenderObject {
...
// UpdateRenderObject implements RenderObjectUpdater.
func (p PositionedWidget) UpdateRenderObject(ro render.RenderObject, oldWidget ui.Widget) {
...
func (p PositionedWidget) GetChildWidget() ui.Widget {
	return p.child
}
