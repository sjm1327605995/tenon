...
func (v *View) SetBorderRadiusTL(radius float32) *View {
	v.GetElement().BorderRadius.TopLeft = radius
	return v
}

func (v *View) SetBorderRadiusTR(radius float32) *View {
	v.GetElement().BorderRadius.TopRight = radius
	return v
}

func (v *View) SetBorderRadiusBR(radius float32) *View {
	v.GetElement().BorderRadius.BottomRight = radius
	return v
}

func (v *View) SetBorderRadiusBL(radius float32) *View {
	v.GetElement().BorderRadius.BottomLeft = radius
	return v
}
