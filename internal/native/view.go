...
func (v *View) SyncFrom(src core.Element) {
	...
	sb := &core.SyncBuilder{}
	core.SyncColor(sb, &v.backgroundColor, other.backgroundColor)
	core.SyncColor(sb, &v.borderColor, other.borderColor)
	if !core.ColorsEqual(v.shadowColor, other.shadowColor) || v.shadowBlur != other.shadowBlur ||
	...
	core.SyncField(sb, &v.BorderRadius, other.BorderRadius)
	sb.MarkDraw(v)
}
